...
class DeviceScreen extends StatelessWidget {
  ...
  void _sendMusicInfo(BluetoothCharacteristic characteristic) async {
    try {
      final String musicInfo = await platform.invokeMethod('getMusicInfo');
      List<int> bytes = musicInfo.codeUnits;
